...
Version  : 2.7.0
Release  : 33
URL      : https://cran.r-project.org/src/contrib/magick_2.7.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/magick_2.7.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1615306814
